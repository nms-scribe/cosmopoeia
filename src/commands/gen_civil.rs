...
use crate::algorithms::civilization::populate_towns;
...
subcommand_def!{
    ...
    pub(crate) struct GenCivilCreateTowns {
...
impl Task for GenCivilCreateTowns {
...
subcommand_def!{
    /// Generates background population of tiles
    pub(crate) struct GenCivilPopulateTowns {
...
impl Task for GenCivilPopulateTowns {
...
subcommand_def!{
    /// Generates background population of tiles
    pub(crate) struct GenCivilCreateSubnations {
...
impl Task for GenCivilCreateSubnations {
...
subcommand_def!{
    /// Generates background population of tiles
    pub(crate) struct GenCivilExpandSubnations {
...
impl Task for GenCivilExpandSubnations {
